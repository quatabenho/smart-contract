    ...
    return (
        <section className="text-gray-800 max-w-[1440px] mx-auto lg:w-3/4 px-2 py-4 justify-center flex items-center flex-col">
            ...
            <h1 className="text-[20px]">
                {walletReady && data != null ? `${data}` : "Đang xử lý..."}
            </h1><br />
            {!account ? <ConnectButton /> : (
                <form onSubmit={changeMessage} className="change">
                    <div className="flex space-x-4">
                        ...
                        />
                        <button className={`border border-gray-600 px-4 py-2 rounded-md text-gray-600 hover:bg-gray-300 hover:border-b-4 hover:border-r-4 font-medium ${!walletReady && "disabled cursor-not-allowed hover:border-b-0 hover:border-r-0 bg-gray-400"}`}
                        >
                            <span>Thêm</span>
