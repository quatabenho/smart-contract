      ...
      <div className="flex space-x-4 items-center justify-end">
        <nav>
          <ul className="hidden lg:flex items-center justify-between space-x-4 font-light text-[14px]">
            <Link
              href="https://www.youtube.com/@quatabenho"
              target="_blank"
            ...
            <Link
              href="https://facebook.com/ngui3n"
              target="_blank"
              className="flex flex-col items-end justify-end group"
            >
              <p className="text-[12px] text-gray-500 group-hover:animate-ping">
              ...
              <li className="text-[15px] text-gray-600 group-hover: color:red">
                Facebook
              </li>
            </Link>
            <Link
              href="https://truongphucnguyen.id.vn/"
              target="_blank"
              className="flex flex-col items-end justify-end group"
            >
              <p className="text-[12px] text-gray-500 group-hover:animate-ping">
